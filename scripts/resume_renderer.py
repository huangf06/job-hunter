...
from db.job_db import JobDatabase, Resume
...
class ResumeRenderer:
    ...
    def _build_base_context(self) -> dict:
        ...
        return {
            ...
            # Education (static)
            'edu_master_school': 'Vrije Universiteit Amsterdam',
            'edu_master_location': 'Amsterdam, Netherlands',
            'edu_master_degree': 'M.Sc. in Artificial Intelligence',
            'edu_master_date': 'Sep. 2023 -- Aug. 2025',
            'edu_master_note': 'Thesis: Uncertainty Quantification in Deep Reinforcement Learning',

            'edu_bachelor_school': 'Zhengzhou University',
            'edu_bachelor_location': 'Zhengzhou, China',
            'edu_bachelor_degree': 'B.Eng. in Computer Science',
            'edu_bachelor_date': 'Sep. 2006 -- Jul. 2010',
    ...
    def _build_context(self, tailored: Dict, job: Dict) -> Dict:
        ...
        # Bio - replace company placeholder
